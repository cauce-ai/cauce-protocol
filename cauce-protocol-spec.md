...
#### 4.2.4 Schema Discovery Methods
...
```json
{
  ...
  "skills": [
    ...
    {
      "id": "get_schemas",
      "name": "List Supported Schemas",
      "description": "Get list of payload schemas supported by this Hub"
    },
    {
      "id": "get_schema",
      "name": "Get Schema Definition",
      "description": "Get the full JSON Schema definition for a payload type",
      "inputSchema": {
        "type": "object",
        "properties": {
...
#### 10.3.4 Schemas Resource

List payload schemas supported by this Hub:

```json
{
  "uri": "cauce://schemas",
  "name": "Supported Schemas",
  "description": "Payload schemas supported by this Hub",
  "mimeType": "application/json"
}
```
...
```json
{
  "schemas": [
    ...
    },
    {
      ...
      "version": "1.0",
      "title": "SMS Payload",
      "description": "Payload schema for SMS signals and actions",
      "categories": ["signal", "action"]
    }
  ]
}
...
```json
{
  "uri": "cauce://schemas/{schema_id}",
  "name": "Schema Definition",
  "description": "Full JSON Schema definition for a payload type",
  "mimeType": "application/json"
}
```
